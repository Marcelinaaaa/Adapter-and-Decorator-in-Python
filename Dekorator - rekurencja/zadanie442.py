...
def debug(f):
    ...
    def new_f(*args):
        ...
        print('argument:', *args, 'value:', f(*args))
        return f(*args)
    return new_f
...
# Jeśli jest wiele dekoratorów, to są one wykonywane od dołu do góry. Na przykład
#
# @firstdecor
# @seconddecor
# def fn():
#   ...
#
# jest równoważne fn = firstdecor(seconddecor(fn))